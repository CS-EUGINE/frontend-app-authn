            ...
            <Form id="registration-form" name="registration-form">
              ...
              {!flags.autoGeneratedUsernameEnabled && (
                <UsernameField
                  ...
                  label={formatMessage(messages['registration.username.label'])}
              ...
              <StatefulButton
                ...
                name="register-user"
                type="submit"
                className="register-button tw:w-full tw:h-[60px] tw:bg-[#2648E4] tw:hover:bg-[#2E2579] tw:transition mt-4 mb-4"
                state={submitState}
                labels={{
                  default: buttonLabel,
                  pending: '',
